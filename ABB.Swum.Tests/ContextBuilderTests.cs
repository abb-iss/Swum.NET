...
namespace ABB.Swum.Tests
{
    ...
    public class ContextBuilderTests
    {
        ...
        {
            if (mc1 == null && mc2 == null) { return true; }
            if ((mc1 == null) ^ (mc2 == null)) { return false; }
            ...
            {
                if (!mc1.FormalParameters[i].Equals(mc2.FormalParameters[i])) { return false; }
            }
            return true;
        }
        ...
        {
            if (fc1 == null && fc2 == null) { return true; }
