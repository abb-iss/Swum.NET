...
namespace ABB.Swum
{
    ...
    /// </summary>
    public class CheckerRule : UnigramMethodRule
    {
        /// <summary>
        /// Creates a new CheckerRule using default values for data sets.
        /// </summary>
        public CheckerRule() : base() { }
        ...
        public CheckerRule(HashSet<string> specialWords, HashSet<string> booleanArgumentVerbs, HashSet<string> nounPhraseIndicators, PositionalFrequencies positionalFrequencies)
        ...
        protected override bool MakeClassification(MethodDeclarationNode node)
        {
            ...
            {
                return IsChecker(node.ParsedName[0].Text);
            }
            else
            {
                return false;
